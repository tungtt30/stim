...
const SideBar = () => {
    return (
        <div className="text-gray-500 bg-black px-5 pt-5 pb-36 scrollbar-hidden overflow-y-scroll lg:text-xs border-r border-gray-900 h-screen  sm:max-w-[12rem] lg:max-w-[15rem] hidden md:block ">
