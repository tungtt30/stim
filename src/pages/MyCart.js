                        ...
                        <div className=''>
                            <div className='flex justify-between my-2 p-2'>
                                <div className='ml-4 font-mono' >
                                    <p className='text-xl'>wallet: $ 240</p>
                        ...
                        <div className='h-auto w-full ml-10'>
                            ...
                            <div className='space-y-1'>
                                ...
                                <div className='space-x-2'>
                                    ...
                                    <input placeholder='123' className='w-32 h-7 rounded-lg border border-violet-800 mx-2 p-1 ' />
                                </div>
                            </div>
                            <div className='bg-green-500 rounded-lg w-60 text-white m-4 p-2 cursor-pointer text-center text-lg hover:bg-green-800'>
                                Pay
                            </div>
                        </div>
                    </div>
